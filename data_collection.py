...
# # Function to capture images for different signs within a Region of Interest (ROI)
# def capture_images_with_roi():
#     cap = cv2.VideoCapture(0)  # Start video capture
#     num_images = 200  # Number of images to capture for each sign

#     # Define the ROI (Region of Interest)
#     x_start, y_start, width, height = 100, 100, 300, 300  # You can adjust this based on your screen size
...
#             # Extract the ROI (crop the frame)
...
#                 cv2.imwrite(image_path, roi)  # Save the cropped ROI
